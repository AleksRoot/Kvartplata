 ...
 * @author Саша
 */
public class PaymentRate extends javax.swing.JFrame {

    /**
     * Creates new form PaymentRate
     */
    public PaymentRate() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentRate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentRate().setVisible(true);
            }
        });
    }
